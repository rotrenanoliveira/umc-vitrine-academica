...
describe('(E2E) - POST /api/v1/institutions/:institutionId/memberships/professors', () => {
  ...
  it('should be able to request a professor membership', async () => {
    ...
    const response = await request(app.server)
      .post(`/api/v1/institutions/${institution.id.toString()}/memberships/professors`)
      .send({ userId: professor.id.toString() })
