...
describe('(E2E) - PUT /api/v1/institutions/members/:memberId/finish', () => {
  afterAll(async () => await app.close())

  it('should be able to finish an institution member', async () => {
    ...
    const response = await request(app.server)
      .put(`/api/v1/institutions/members/${member.id.toString()}/finish`)
