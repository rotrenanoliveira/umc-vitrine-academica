...
import type { InactivateInstitutionMemberUseCase } from '@/domain/institution/application/use-cases/institution-membership/inactivate-institution-member'
...
export class InactivateInstitutionMemberController {
  constructor(private readonly useCase: InactivateInstitutionMemberUseCase) {}
