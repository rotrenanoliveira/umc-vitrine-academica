...
import type { FetchPendingStudentMembershipsUseCase } from '@/domain/institution/application/use-cases/institution-membership/fetch-pending-student-memberships'
...
export class FetchPendingStudentMembershipsController {
  constructor(private readonly useCase: FetchPendingStudentMembershipsUseCase) {}
