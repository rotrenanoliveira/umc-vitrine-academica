...
import type { SuspendInstitutionMemberUseCase } from '@/domain/institution/application/use-cases/institution-membership/suspend-institution-member'
...
export class SuspendInstitutionMemberController {
  constructor(private readonly useCase: SuspendInstitutionMemberUseCase) {}
