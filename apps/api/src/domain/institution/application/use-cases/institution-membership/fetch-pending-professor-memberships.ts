...
interface FetchPendingProfessorMembershipsRequest {
  actorId: string
  institutionId: string
}

type FetchPendingProfessorMembershipsResponse = Either<
  InstitutionNotFoundError | UnauthorizedError,
  { members: InstitutionMember[] }
>

export class FetchPendingProfessorMembershipsUseCase {
  constructor(
  ...
  async execute({
    actorId,
    institutionId,
  }: FetchPendingProfessorMembershipsRequest): Promise<FetchPendingProfessorMembershipsResponse> {
